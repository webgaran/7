...
?>
<div id="main-content" class="single download">
    <div class="container">
        <?php if(have_posts()): ?>
                ...
                <div class="post-entry">
                    ...
                    <div class="post-meta">
                        ...
                        <span class="meta comment"><i class="fa fa-comment"></i>
                            <?php
                            comments_popup_link(__( 'بدون دیدگاه','sltheme'),__('1 دیدگاه','sltheme'), '% دیدگاه', 'comments-link', 'دیدگاه ها غیر فعال');
                            ?>
                        </span>
                    ...
                    <div class="post-categories">
                        <span><?php _e('دسته بندی ها: ','sltheme'); ?></span>
                        <?php the_category(','); ?>
                    </div>
                    <div class="post-tags">
                        <span><?php _e('برچسب ها : ','sltheme'); ?></span>
                        <?php the_tags('',','); ?>
                    </div>
                    <div class="post-sizes">
                        <span>اندازه ها : </span>
                        <?php the_terms(get_the_ID(),'size','',',',''); ?>
                    </div>
